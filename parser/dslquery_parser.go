...
type DslQueryParser struct {
	*antlr.BaseParser
}

func NewDslQueryParser(input antlr.TokenStream) *DslQueryParser {
	this := new(DslQueryParser)
	...
	this.GrammarFileName = "DslQuery.g4"

	return this
}

// DslQueryParser tokens.
const (
	DslQueryParserEOF                 = antlr.TokenEOF
	DslQueryParserT__0                = 1
	DslQueryParserT__1                = 2
	DslQueryParserBOOLEAN             = 3
	DslQueryParserNULL                = 4
	DslQueryParserCOMPARISON_OPERATOR = 5
	DslQueryParserAND                 = 6
	DslQueryParserOR                  = 7
	DslQueryParserO                   = 8
	DslQueryParserR                   = 9
	...
	DslQueryParserSW                  = 22
	DslQueryParserEW                  = 23
	DslQueryParserBR_OPEN             = 24
	DslQueryParserBR_CLOSE            = 25
	DslQueryParserATTRNAME            = 26
	DslQueryParserSTRING              = 27
	DslQueryParserDOUBLE              = 28
	DslQueryParserINT                 = 29
	DslQueryParserEXP                 = 30
	DslQueryParserWS                  = 31
)

// DslQueryParser rules.
const (
	DslQueryParserRULE_start     = 0
	DslQueryParserRULE_query     = 1
	DslQueryParserRULE_attrPath  = 2
	DslQueryParserRULE_attrValue = 3
)
...
func NewEmptyStartContext() *StartContext {
	...
	p.RuleIndex = DslQueryParserRULE_start
	return p
}
...
func (s *StartContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(DslQueryListener); ok {
...
func (p *DslQueryParser) Start() (localctx IStartContext) {
	localctx = NewStartContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, DslQueryParserRULE_start)
...
func NewEmptyQueryContext() *QueryContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = DslQueryParserRULE_query
	return p
}
...
func (s *CompareExpContext) COMPARISON_OPERATOR() antlr.TerminalNode {
	return s.GetToken(DslQueryParserCOMPARISON_OPERATOR, 0)
}
...
func (s *AndLogicalExpContext) AND() antlr.TerminalNode {
	return s.GetToken(DslQueryParserAND, 0)
}
...
func (s *BracketExpContext) BR_OPEN() antlr.TerminalNode {
	return s.GetToken(DslQueryParserBR_OPEN, 0)
}

func (s *BracketExpContext) BR_CLOSE() antlr.TerminalNode {
	return s.GetToken(DslQueryParserBR_CLOSE, 0)
}
...
func (s *OrLogicalExpContext) OR() antlr.TerminalNode {
	return s.GetToken(DslQueryParserOR, 0)
}
...
func (p *DslQueryParser) Query() (localctx IQueryContext) {
	return p.query(0)
}

func (p *DslQueryParser) query(_p int) (localctx IQueryContext) {
	...
	_startState := 2
	p.EnterRecursionRule(localctx, 2, DslQueryParserRULE_query, _p)
	...
	case DslQueryParserBR_OPEN:
...

		{
			...
			var _m = p.Match(DslQueryParserBR_OPEN)
		...
		}
		{
			...
			var _m = p.Match(DslQueryParserBR_CLOSE)

			localctx.(*BracketExpContext).rightBracket = _m
		}

	case DslQueryParserATTRNAME:
		...
		}
		{
			...
			var _m = p.Match(DslQueryParserCOMPARISON_OPERATOR)
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			case 1:
				...
				p.PushNewRecursionContext(localctx, _startState, DslQueryParserRULE_query)
				p.SetState(21)
				...
				}
				{
					...
					var _m = p.Match(DslQueryParserAND)
			...
			case 2:
				...
				}
				{
					...
					var _m = p.Match(DslQueryParserOR)
...
func NewEmptyAttrPathContext() *AttrPathContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = DslQueryParserRULE_attrPath
	return p
}
...
func (s *AttrPathContext) AllATTRNAME() []antlr.TerminalNode {
	return s.GetTokens(DslQueryParserATTRNAME)
}

func (s *AttrPathContext) ATTRNAME(i int) antlr.TerminalNode {
	return s.GetToken(DslQueryParserATTRNAME, i)
}
...
func (p *DslQueryParser) AttrPath() (localctx IAttrPathContext) {
	localctx = NewAttrPathContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 4, DslQueryParserRULE_attrPath)
	var _la int
	...
	{
		p.SetState(32)
		p.Match(DslQueryParserATTRNAME)
	}
	p.SetState(35)
	p.GetErrorHandler().Sync(p)
	_la = p.GetTokenStream().LA(1)

	if _la == DslQueryParserT__0 {
		{
			p.SetState(33)
			p.Match(DslQueryParserT__0)
		}
		{
			p.SetState(34)
			p.Match(DslQueryParserATTRNAME)
...
func NewEmptyAttrValueContext() *AttrValueContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = DslQueryParserRULE_attrValue
	return p
}
...
func (s *BooleanContext) BOOLEAN() antlr.TerminalNode {
	return s.GetToken(DslQueryParserBOOLEAN, 0)
}
...
func (s *NullContext) NULL() antlr.TerminalNode {
	return s.GetToken(DslQueryParserNULL, 0)
}
...
func (s *StringContext) STRING() antlr.TerminalNode {
	return s.GetToken(DslQueryParserSTRING, 0)
}
...
func (s *DoubleContext) DOUBLE() antlr.TerminalNode {
	return s.GetToken(DslQueryParserDOUBLE, 0)
}
...
func (s *LongContext) INT() antlr.TerminalNode {
	return s.GetToken(DslQueryParserINT, 0)
}

func (s *LongContext) EXP() antlr.TerminalNode {
	return s.GetToken(DslQueryParserEXP, 0)
}
...
func (p *DslQueryParser) AttrValue() (localctx IAttrValueContext) {
	localctx = NewAttrValueContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 6, DslQueryParserRULE_attrValue)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case DslQueryParserBOOLEAN:
		localctx = NewBooleanContext(p, localctx)
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(37)
			p.Match(DslQueryParserBOOLEAN)
		}

	case DslQueryParserNULL:
		localctx = NewNullContext(p, localctx)
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(38)
			p.Match(DslQueryParserNULL)
		}

	case DslQueryParserSTRING:
		localctx = NewStringContext(p, localctx)
		p.EnterOuterAlt(localctx, 3)
		{
			p.SetState(39)
			p.Match(DslQueryParserSTRING)
		}

	case DslQueryParserDOUBLE:
		localctx = NewDoubleContext(p, localctx)
		p.EnterOuterAlt(localctx, 4)
		{
			p.SetState(40)
			p.Match(DslQueryParserDOUBLE)
		}

	case DslQueryParserT__1, DslQueryParserINT:
		...
		if _la == DslQueryParserT__1 {
			{
				p.SetState(41)
				p.Match(DslQueryParserT__1)
			}

		}
		{
			p.SetState(44)
			p.Match(DslQueryParserINT)
		}
		p.SetState(46)
		p.GetErrorHandler().Sync(p)
...
func (p *DslQueryParser) Sempred(localctx antlr.RuleContext, ruleIndex, predIndex int) bool {
	switch ruleIndex {
	case 1:
...
func (p *DslQueryParser) Query_Sempred(localctx antlr.RuleContext, predIndex int) bool {
	switch predIndex {
	case 0:
